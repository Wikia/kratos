...
type IdentityApi interface {
	...
	/*
			 * AdminCurrentSessionExtend Calling this endpoint refreshes a current user session. If `session.refresh_min_time_left` is set it will only refresh the session after this time has passed.
	...
	*/
	...
	/*
	 * AdminCurrentSessionExtendExecute executes the request
	 * @return Session
	 */
	...
	*/
	AdminUpdateCredentials(ctx context.Context, id string) IdentityApiApiAdminUpdateCredentialsRequest
	...
	*/
	AdminUpdateIdentityBody(ctx context.Context) IdentityApiApiAdminUpdateIdentityBodyRequest
...
func (r IdentityApiApiAdminCurrentSessionExtendRequest) Execute() (*Session, *http.Response, error) {
	return r.ApiService.AdminCurrentSessionExtendExecute(r)
}
...
func (a *IdentityApiService) AdminCurrentSessionExtendExecute(r IdentityApiApiAdminCurrentSessionExtendRequest) (*Session, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityApiService.AdminCurrentSessionExtend")
	if err != nil {
...
func (r IdentityApiApiAdminIdentitySessionRequest) Upgrade(upgrade bool) IdentityApiApiAdminIdentitySessionRequest {
	r.upgrade = &upgrade
	return r
}

func (r IdentityApiApiAdminIdentitySessionRequest) Execute() (*SuccessfulAdminIdentitySession, *http.Response, error) {
...
func (a *IdentityApiService) AdminIdentitySessionExecute(r IdentityApiApiAdminIdentitySessionRequest) (*SuccessfulAdminIdentitySession, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityApiService.AdminIdentitySession")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r IdentityApiApiAdminUpdateCredentialsRequest) Execute() (*http.Response, error) {
...
func (a *IdentityApiService) AdminUpdateCredentialsExecute(r IdentityApiApiAdminUpdateCredentialsRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityApiService.AdminUpdateCredentials")
	if err != nil {
...
func (a *IdentityApiService) AdminUpdateIdentityBodyExecute(r IdentityApiApiAdminUpdateIdentityBodyRequest) (*Identity, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityApiService.AdminUpdateIdentityBody")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
