...
type V0alpha2Api interface {
	...
	*/
	 ...
	 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	 * @param id ID is the identity's ID.
	 * @param credentialType credentialType is the type of credential
	 * @return V0alpha2ApiApiAdminDeleteIdentityCredentialRequest
	 */
	AdminDeleteIdentityCredential(ctx context.Context, id string, credentialType string) V0alpha2ApiApiAdminDeleteIdentityCredentialRequest

	/*
	 * AdminDeleteIdentityCredentialExecute executes the request
	 */
	AdminDeleteIdentityCredentialExecute(r V0alpha2ApiApiAdminDeleteIdentityCredentialRequest) (*http.Response, error)
	...
	*/
	...
	/*
			 * AdminIdentitySession Calling this endpoint issues a session for a given identity.
			 * This endpoint is useful for:

		Issuing session or session token for a given identity without authenticating
			 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			 * @param id ID is the identity's ID.
			 * @return V0alpha2ApiApiAdminIdentitySessionRequest
	*/
	AdminIdentitySession(ctx context.Context, id string) V0alpha2ApiApiAdminIdentitySessionRequest

	/*
	 * AdminIdentitySessionExecute executes the request
	...
	*/
	...
	/*
		...
		Learn how identities work in [Ory Kratos' User And Identity Model Documentation](https://www.ory.sh/docs/next/kratos/concepts/identity-user-model).
			 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			 * @param id ID is the identity's ID.
			 * @return V0alpha2ApiApiAdminUpdateCredentialsRequest
	*/
	AdminUpdateCredentials(ctx context.Context, id string) V0alpha2ApiApiAdminUpdateCredentialsRequest

	/*
	 * AdminUpdateCredentialsExecute executes the request
	 */
...
type V0alpha2ApiApiAdminDeleteIdentityCredentialRequest struct {
	ctx            context.Context
	ApiService     V0alpha2Api
	id             string
...
func (r V0alpha2ApiApiAdminDeleteIdentityCredentialRequest) Execute() (*http.Response, error) {
	return r.ApiService.AdminDeleteIdentityCredentialExecute(r)
}
 ...
 * @return V0alpha2ApiApiAdminDeleteIdentityCredentialRequest
 */
func (a *V0alpha2ApiService) AdminDeleteIdentityCredential(ctx context.Context, id string, credentialType string) V0alpha2ApiApiAdminDeleteIdentityCredentialRequest {
	return V0alpha2ApiApiAdminDeleteIdentityCredentialRequest{
		ApiService:     a,
		ctx:            ctx,
		id:             id,
 ...
 * Execute executes the request
 */
func (a *V0alpha2ApiService) AdminDeleteIdentityCredentialExecute(r V0alpha2ApiApiAdminDeleteIdentityCredentialRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "V0alpha2ApiService.AdminDeleteIdentityCredential")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/identities/{id}/credential/{credentialType}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"credentialType"+"}", url.PathEscape(parameterToString(r.credentialType, "")), -1)
...
type V0alpha2ApiApiAdminIdentitySessionRequest struct {
	ctx        context.Context
	ApiService V0alpha2Api
	id         string
}
...
func (r V0alpha2ApiApiAdminIdentitySessionRequest) Execute() (*SuccessfulAdminIdentitySession, *http.Response, error) {
	return r.ApiService.AdminIdentitySessionExecute(r)
}
...
Issuing session or session token for a given identity without authenticating
  ...
  - @return V0alpha2ApiApiAdminIdentitySessionRequest
*/
func (a *V0alpha2ApiService) AdminIdentitySession(ctx context.Context, id string) V0alpha2ApiApiAdminIdentitySessionRequest {
	return V0alpha2ApiApiAdminIdentitySessionRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return SuccessfulAdminIdentitySession
 */
func (a *V0alpha2ApiService) AdminIdentitySessionExecute(r V0alpha2ApiApiAdminIdentitySessionRequest) (*SuccessfulAdminIdentitySession, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "V0alpha2ApiService.AdminIdentitySession")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type V0alpha2ApiApiAdminUpdateCredentialsRequest struct {
	ctx        context.Context
	ApiService V0alpha2Api
	id         string
}

func (r V0alpha2ApiApiAdminUpdateCredentialsRequest) Execute() (*http.Response, error) {
	return r.ApiService.AdminUpdateCredentialsExecute(r)
}
...
Learn how identities work in [Ory Kratos' User And Identity Model Documentation](https://www.ory.sh/docs/next/kratos/concepts/identity-user-model).
  ...
  - @return V0alpha2ApiApiAdminUpdateCredentialsRequest
*/
func (a *V0alpha2ApiService) AdminUpdateCredentials(ctx context.Context, id string) V0alpha2ApiApiAdminUpdateCredentialsRequest {
	return V0alpha2ApiApiAdminUpdateCredentialsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *V0alpha2ApiService) AdminUpdateCredentialsExecute(r V0alpha2ApiApiAdminUpdateCredentialsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "V0alpha2ApiService.AdminUpdateCredentials")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/identities/{id}/credentials"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
