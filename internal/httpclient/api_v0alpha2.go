	...
	*/
	...
	/*
		...
		To forcefully logout Identity from all devices and sessions
			 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			 * @param id ID is the identity's ID.
			 * @return V0alpha2ApiApiAdminLogoutIdentityRequest
	*/
	AdminLogoutIdentity(ctx context.Context, id string) V0alpha2ApiApiAdminLogoutIdentityRequest

	/*
	 * AdminLogoutIdentityExecute executes the request
	 */
	AdminLogoutIdentityExecute(r V0alpha2ApiApiAdminLogoutIdentityRequest) (*http.Response, error)
...
type V0alpha2ApiApiAdminLogoutIdentityRequest struct {
	ctx        context.Context
	ApiService V0alpha2Api
	id         string
}

func (r V0alpha2ApiApiAdminLogoutIdentityRequest) Execute() (*http.Response, error) {
 ...
 * @return V0alpha2ApiApiAdminLogoutIdentityRequest
*/
func (a *V0alpha2ApiService) AdminLogoutIdentity(ctx context.Context, id string) V0alpha2ApiApiAdminLogoutIdentityRequest {
	return V0alpha2ApiApiAdminLogoutIdentityRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *V0alpha2ApiService) AdminLogoutIdentityExecute(r V0alpha2ApiApiAdminLogoutIdentityRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "V0alpha2ApiService.AdminLogoutIdentity")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
